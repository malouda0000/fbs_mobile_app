...
final List<MyCustomOnBording> mainCustomOnBordingList = [
  MyCustomOnBording(
    ...
    imagePath: AppImages.onbordingone,
  ),
  MyCustomOnBording(
    ...
    imagePath: AppImages.onbordingTwo,
  ),
  MyCustomOnBording(
    ...
    imagePath: AppImages.onbordingThree,
  ),
  MyCustomOnBording(
    ...
    imagePath: AppImages.onbordingFour,
  ),
  MyCustomOnBording(
    title: 'smart designs',
    discription:
    ...
    // title: AppLocal.fastDelivery.tr,
    // discription: AppLocal.fastDeliveryDiscription.tr,
    imagePath: AppImages.onbordingFive,
  ),
];
